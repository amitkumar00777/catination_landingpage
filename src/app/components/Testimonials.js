...
const testimonials = [
  ...
  // 🌍 New Dubai client
  {
    ...
    content: "Catination CRM streamlined my client follow-ups and boosted engagement. In Dubai’s competitive market, the email campaigns gave me a real advantage.",
    rating: 5,
    location: "Dubai, UAE",
  },
  // 🇮🇳 Indian Client #1
  {
    ...
    content: "The bulk email marketing tools helped me capture leads across multiple cities in India. I can now manage and track thousands of prospects effortlessly.",
    rating: 5,
  ...
  // 🇮🇳 Indian Client #2
  {
    ...
    company: "Iyer Realty",
    content: "Catination CRM is a game changer for lead nurturing. Automated workflows and CRM integration mean I never miss a follow-up again.",
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto">
            From the skyscrapers of Dubai to the bustling cities of India, Catination CRM empowers real estate leaders to capture leads, close deals, and scale their business with ease.
          </p>
        </div>
